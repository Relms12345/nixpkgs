...
let
  ...
  src = fetchFromGitHub {
    owner = "Relms12345";
    repo = "litellm";
    rev = "e84ce661fe85a662ae9735c42496773d566c7d67";
    hash = "sha256-CRH00ypDXHbbbhhIOSQXxNYbXTy3LEpb8bcOPRmY4Mo=";
  };
...
buildPythonPackage rec {
  ...
  cargoDeps = rustPlatform.fetchCargoVendor {
    ...
    hash = "sha256-9mR5x76Fyn/VXOXmJ6X15LHpH4XrdBAYNrCG8huceG0=";
  };
