...
let
  ...
  src = fetchFromGitHub {
    owner = "streber42";
    repo = "litellm";
    rev = "7d4c1dc1418d3a691a3f65d5b665303b12a1dafd";
    hash = "sha256-JS9HquZl9uFdlen27gFecY04IygAEIrWmTO9K7Jwjqc=";
  };
...
buildPythonPackage rec {
  ...
  cargoDeps = rustPlatform.fetchCargoVendor {
    ...
    hash = "sha256-FFVbZ/rnPXattllOv+ZYZO8JLXzGOq70fhyWT39lJnI=";
  };
